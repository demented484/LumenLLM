    ...
    pub(super) fn new_state(&self) -> Result<CudaLlamaState> {
        ...
        let prefill = if self.prefill_chunk_size > 1 {
            ...
            Some(CudaPrefillScratch {
                ...
                mrope_pos_t: self.runtime.alloc_u32(self.prefill_chunk_size)?,
                mrope_pos_h: self.runtime.alloc_u32(self.prefill_chunk_size)?,
                mrope_pos_w: self.runtime.alloc_u32(self.prefill_chunk_size)?,
                mrope_active: false,
