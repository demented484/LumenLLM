...
extern "C" __global__ void aegis_sdpa_decode(
    const unsigned short* key_cache,
    const unsigned short* value_cache,
    const float* query,
    const unsigned int seq_len,
...
extern "C" __global__ void aegis_sdpa_decode_streaming(
    const unsigned short* key_cache,
    const unsigned short* value_cache,
    const float* query,
    const unsigned int seq_len,
...
extern "C" __global__ void aegis_sdpa_prefill_dense_cache(
    const unsigned short* key_cache,
    const unsigned short* value_cache,
    const float* query,
    const unsigned int start_position,
...
extern "C" __global__ void aegis_sdpa_prefill_dense_online(
    const unsigned short* key_cache,
    const unsigned short* value_cache,
    const float* query,
    const unsigned int start_position,
...
extern "C" __global__ void aegis_sdpa_prefill_paged_varlen(
    const unsigned short* key_cache,
    const unsigned short* value_cache,
    const float* query,
    const unsigned int* slot_mapping,
