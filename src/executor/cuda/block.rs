...
#[derive(Debug)]
#[allow(dead_code)]
pub(in crate::executor) struct CudaLayerBlockExecutor {
...
#[derive(Debug)]
#[allow(dead_code)]
pub(in crate::executor) struct CudaLayerBlockState {
...
impl CudaLayerBlockExecutor {
    ...
    #[allow(dead_code)]
    pub(in crate::executor) fn new_state(&self) -> Result<CudaLayerBlockState> {
